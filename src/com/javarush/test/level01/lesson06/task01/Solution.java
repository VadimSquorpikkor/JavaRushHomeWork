...
public class Solution
{
    public static void main(String[] args)
    {
        ...
        System.out.println();
        System.out.println("Я согласен на зарплату $800/месяц в первый год.");//напишите тут ваш код
        System.out.println("Я согласен на зарплату $1500/месяц во второй год.");//напишите тут ваш код
        System.out.println("Я согласен на зарплату $2200/месяц в третий год.");//напишите тут ваш код
        System.out.println("Я согласен на зарплату $2700/месяц в четвертый год.");//напишите тут ваш код
        System.out.println("Я согласен на зарплату $3200/месяц в пятый год.");//напишите тут ваш код
        System.out.println();
